1. `body-parser`: This middleware parses incoming request bodies and makes the data available on the req.body object. It supports various types of request data, including JSON, URL-encoded, and raw data.
